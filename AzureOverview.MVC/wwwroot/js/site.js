...
function ShowHideInfo() {
    ...
    //show info and feature row on click of a service
    $("div[id^='service']").click(function () {
...
function Autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].substr(0, arr[i].length).toUpperCase().includes(val.toUpperCase())) {
